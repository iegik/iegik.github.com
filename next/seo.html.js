...
`;var R=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 622 124" fill="currentColor" fill-rule="evenodd">
...
`;var I=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 46 33" stroke-width="1.8" fill="none" fill-rule="evenodd" stroke="currentColor">
...
</svg>`;var F=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 174 33" stroke-width="1.8" fill="none" fill-rule="evenodd" stroke="currentColor">
  <path d="M23.4888889,20.543316 C21.4404656,18.4187374 19.0750303,15.6666667 16.4832014,15.6666667 C13.8721947,15.6666667 11.7555556,17.6366138 11.7555556,20.0666667 C11.7555556,22.4967196 13.8721947,24.4666667 16.4832014,24.4666667 C18.8347252,24.4666667 19.9845474,23.0125628 20.6429148,22.312473" stroke-linecap="round"></path>
  <path d="M22.5111111,19.5900174 C24.5595344,21.7145959 26.9249697,24.4666667 29.5167986,24.4666667 C32.1278053,24.4666667 34.2444444,22.4967196 34.2444444,20.0666667 C34.2444444,17.6366138 32.1278053,15.6666667 29.5167986,15.6666667 C27.1652748,15.6666667 26.0154526,17.1207706 25.3570852,17.8208603" stroke-linecap="round"></path>
  <path d="M45,22.7331459 C45,19.1499462 42.7950446,16.079593 39.6628004,14.7835315 C39.6774469,14.5246474 39.7003932,14.2674038 39.7003932,14.0035978 C39.7003932,6.82243304 33.8412885,1 26.611593,1 C21.3985635,1 16.9102123,4.03409627 14.8051788,8.41527616 C13.7828502,7.62878013 12.503719,7.15547161 11.1134367,7.15547161 C7.77825654,7.15547161 5.07450503,9.84159999 5.07450503,13.1544315 C5.07450503,13.7760488 5.16938207,14.3779791 5.3477444,14.9418479 C2.74863428,16.4787471 1,19.2867709 1,22.5105187 C1,27.3287502 4.89630545,31.2367856 9.72803666,31.31094 L36.3341301,31.3109406 C41.1201312,31.3406346 45,27.4870665 45,22.7331459 L45,22.7331459 Z" stroke-linejoin="round"></path>
...
`}return[l.map(p=>`%c${p}`).join(""),...h.map(p=>`background-color: ${p};`)]}var N1=q(),j1=()=>(setTimeout(async()=>{if(typeof window>"u"||typeof document>"u")return;let e=await G("images/artursjansons_32.jpg");b(...e)}),`
  ...
  `,Y=R1;var I1=({nonce:e})=>Object.entries({"script-src":[`'nonce-${e}'`,"'strict-dynamic'","https://www.google-analytics.com","https://ssl.google-analytics.com","https://static.hotjar.com","https://script.hotjar.com","https://js.sentry-cdn.com","'unsafe-inline'"],"img-src":["'self'","https://www.google-analytics.com","https://avatars.githubusercontent.com/","https://www.googletagmanager.com/","https://static.hotjar.com","https://survey-images.hotjar.com"],"connect-src":["'self'","https://www.google-analytics.com","https://region1.google-analytics.com","https://in.hotjar.com","wss://ws.hotjar.com","https://static.hotjar.com","https://content.hotjar.io","https://github.com/login/oauth/access_token","https://api.github.com/graphql","https://api.github.com/user","https://o171820.ingest.sentry.io/"],"style-src":["'self'",`'nonce-${e}'`,"https://static.hotjar.com"],"object-src":["'none'"],"base-uri":["'none'"],"frame-src":["https://vars.hotjar.com/"],"script-src-elem":["'self'",`'nonce-${e}'`,"https://script.hotjar.com"]}).reduce((t,[r,o])=>`${t};${r} ${o.join(" ")}`,"default-src 'self'"),W=({nonce:e})=>`<meta http-equiv="Content-Security-Policy" content="${I1({nonce:e})}">`;var a=({srcDoc:e,src:t,nonce:r,async:o,prefix:i,postfix:n,iife:s,crossorigin:c="",integrity:l})=>{let h=e?v(e):"";return`<script ${o?"async":""} crossorigin="${c}" ${l?`integrity="${l}"`:""} nonce="${r}" ${t?`src="${t}"`:""}>${i||""}${s?`(${h})(${s});`:h}${n||""}</script>`};var Q=({nonce:e,gtmId:t})=>`
...
`;var F1=v("./public/next/styles.min.css"),_1="Art\u016Brs Jansons :: Web Developer",D1="Experienced web developer with a passion for innovation, automation and optimization",V1=`<!DOCTYPE html>
<html lang="en" manifest="manifest.appcache">
  ...
  <body>
    ...
    ${Q({nonce:d,gtmId:"G-5ZY8Y6X2C4"})}
    
    ${e1({nonce:d,gtmId:"GTM-MBG56M"})}
    ${z()}
    <div id="root">${Y()}</div>
