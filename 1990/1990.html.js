#!/usr/bin/env node
"use strict";var J=Object.create;var D=Object.defineProperty;var Q=Object.getOwnPropertyDescriptor;var Z=Object.getOwnPropertyNames;var X=Object.getPrototypeOf,K=Object.prototype.hasOwnProperty;var tt=(t,e,o,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Z(e))!K.call(t,r)&&r!==o&&D(t,r,{get:()=>e[r],enumerable:!(s=Q(e,r))||s.enumerable});return t};var et=(t,e,o)=>(o=t!=null?J(X(t)):{},tt(e||!t||!t.__esModule?D(o,"default",{value:t,enumerable:!0}):o,t));var u=et(require("fs")),f=(t,e)=>u.writeFileSync(t,e,{encoding:"utf8"}),l=t=>u.readFileSync(t,{encoding:"utf8"});var E=new Date,G=`v3.1.0-${E.toJSON()}`,n=btoa(`${Number(E)}`).slice(10,18);var b=t=>`<a ${/^http/.test(t.href)?' rel="noopener noreferrer"':""} href="${t.href}" title="${t.title}">${t.title}</a>`;var y=t=>t.replace(/[&<"']/g,e=>{switch(e){case"&":return"&amp;";case"<":return"&lt;";case'"':return"&quot;";default:return"&#039;"}});var w=({src:t})=>`<pre><font size=1>${y(l(t))}</font></pre>`;var x=({src:t,title:e})=>`<fieldset bgcolor="green">
                                                <legend>${e}</legend>
                                                <code width="120px">${y(l(t))}</code>
                                            </fieldset>`;var c=({srcDoc:t,src:e,nonce:o,async:s,prefix:r,postfix:a,iife:g,crossorigin:v="",integrity:m})=>{let h=`${r||""}${t?l(t):""}${a||""}`;return`<script ${s?"async":""} crossorigin="${v}" ${m?`integrity="${m}"`:""} nonce="${o}" ${e?`src="${e}"`:""}>${g?`(${h})(${g})`:h}</script>`};var P=({nonce:t,gtmId:e})=>`
    ${c({nonce:t,srcDoc:"./src/lib/gtm.js",iife:`window,document,'script','dataLayer','${e}','${t}'`})}
`,S=({nonce:t,gtmId:e})=>`<noscript><iframe nonce="${t}" src="https://www.googletagmanager.com/ns.html?id=${e}"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>`;var F=({nonce:t,gtmId:e})=>`
    ${c({async:!0,nonce:t,src:`https://www.googletagmanager.com/gtag/js?id=${e}`})}
    ${c({srcDoc:"./src/lib/gtag.js",nonce:t,postfix:`gtag('config', '${e}');
`})}
`;var z=({name:t,rows:e,cols:o,data:s,type:r,value:a="",required:g,l10n:v})=>{let m=t,h=g?"required":"";return s?`<select id="${m}" name="${t}" ${h}>
                                                              <option></option>
...
`)}
                        ...
                        <a id="toggleDosStyle" href="#exit" bgcolor="red">DOS</a>
                                        ...
                                        <font color="#DA214C">Nest</font>`,p=[{image:{ascii:"./src/pages/1990/assets/website.ascii"},description:"Website development, including complex forms with custom field validation, popups and dialogs.",links:[{href:"https://wiam-front-test.vercel.app/",title:"Ex. 1"},{href:"https://mindmap-opal.vercel.app/",title:"Ex. 2"},{href:"https://codepen.io/iegik/full/ObZpqo",title:"Ex. 3"},{href:"https://test-kanvajs.vercel.app/",title:"Ex. 4"}]},{image:{ascii:"./src/pages/1990/assets/mobile.ascii"},description:"Mobile applications - developing, publishing or upgrading existing ones.",links:[{href:"https://github.com/iegik/inventarizacija/",title:"Ex. 1"},{href:"https://github.com/iegik/react_calc/",title:"Ex. 2"}],comment:"Unfortunately apps are not available in Google Play anymore"},{image:{ascii:"./src/pages/1990/assets/extensions.ascii"},description:"Browser extensions, custom scripts and other researches where I'm testing new approaches.",links:[{href:"https://github.com/iegik/clock-extension",title:"Ex. 1"},{href:"https://github.com/iegik/thunar-scripts",title:"Ex. 2"},{href:"https://hub.docker.com/repository/docker/iegik/docker-node/general",title:"Ex. 3"}]},{image:{ascii:"./src/pages/1990/assets/cms.ascii"},description:"CMS (Wordpress, Magento) configuration, plugin creation, RESTFul API on PHP, GraphQL and microservices",links:[{href:"https://github.com/WinLinMac/magento_themes",title:"Ex. 1"}]}],H=[{link:{href:"https://t.me/ajansons",title:"t.me/ajansons"}}],O=[{href:"https://linkedin.com/in/iegik",title:"LinkedIn"},{href:"https://github.com/iegik",title:"GitHub"},{href:"https://profile.codersrank.io/user/iegik",title:"CodersRank"},{href:"https://codepen.io/iegik/",title:"CodePen"},{href:"https://jsfiddle.net/user/iegik",title:"JSFiddle"},{href:"https://stackoverflow.com/users/771471/iegik",title:"StackOverflow"}],A="'SFMono-Regular', 'SF Mono', 'Ubuntu Mono', Consolas, 'DejaVu Sans Mono', Menlo, monospace",d=t=>`<center>${w({src:t.image.ascii})}</center>
                                            ...
                                            ${t.comment?`<p><em><font color="gray">${t.comment}</font></em>`:""}`,N=()=>"<p>Time Zone: EEST</p>",U=()=>"<p>Work Time: 10:00 - 20:00</p>",W=()=>"<p>Current Location: Earth</p>",R={email:{kind:"vertical",required:!0},to:{type:"hidden",value:"a.jansons+web@gmail.com"},access_key:{type:"hidden",value:"c5540606-b7ca-4634-980a-13e2c50cd823"},redirect:{type:"hidden",value:"/1990/sent"},subject:{kind:"vertical",required:!0,data:["feedback","work","consultation","issue"]},message:{kind:"vertical",required:!0},send:{type:"submit"}},rt={email:"Your email",subject:"Subject",message:"Content",send:"Send message",feedback:"Feedback",work:"Work opportunity",consultation:"Consultation",issue:"Bug Report",botcheck:"I' m not a robot"},k=t=>rt[t]||t,st=()=>t=>e=>{let{name:o}=e,{kind:s,type:r}=R[o]||{},a={...e,...R[o]||{},l10n:k};if(r==="hidden")return t(a);if(r==="submit")return`<input type="submit" name="${o}" value="${k(o)}" />`;let g=k(o);return s==="vertical"?`<label for="${o}">${g}</label>
                                                        <br>
                                                        <br>
                                                        ${t(a)}`:`<label for="${o}">${g}</label>&nbsp;${t(a)}`},i=st()(z),Y=({name:t})=>`<input id="bot" name="${t}" nonce="${n}" value="This shouldn't be here" /><p><a id="${t}" href="#bot">[_] ${k(t)}</a></p><script nonce="${n}">bot.style.display='none';${t}.addEventListener("click", () => {${t}.innerText=${t}.innerText.slice(0,1)+(bot.value==='true' ? '_' : 'x')+${t}.innerText.slice(2);bot.disabled=true;bot.value=bot.value === 'true' ? false : true;});</script>`,at=()=>`<form align="left" method="POST" action="https://api.web3forms.com/submit">
    ...
    "http://www.w3.org/TR/xhtml-basic/xhtml-basic11.dtd">`,V=t=>`${j}
<html lang="en">
<head>
    ${I({nonce:n})}
    <title>${it}</title>
    ...
    ${P({nonce:n,gtmId:"GTM-MBG56M"})}
    
    
</head>
<body>
    
    ${F({nonce:n,gtmId:"G-5ZY8Y6X2C4"})}
    
    ${S({nonce:n,gtmId:"GTM-MBG56M"})}
    ${t}
    
    ${c({srcDoc:"./src/lib/dosTheme.js",nonce:n,prefix:`const nonce = '${n}';
`})}
...
`);f("public/1990/desktop/index.html",V(ct()));f("public/1990/mobile/index.html",V(pt()));var dt=`
CACHE MANIFEST
# rev ${G}
