...
</svg>`;var H=`<svg viewBox="0 0 62 39" fill="currentColor" xmlns="https://www.w3.org/2000/svg" class="main-header-logo">
...
`;var z=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 258 39" fill="currentColor">
...
`;var x={"linkedin-icon":Z,"linkedin-logo":A,"github-icon":T,"github-logo":F,"stackoverflow-icon":P,"stackoverflow-logo":X,"jsfiddle-icon":K,"jsfiddle-logo":D,"codersrank-icon":H,"codersrank-logo":z,"slot-machine-icon":V};var U="https://www.w3.org/2000/svg",b=new Map,E1=()=>`
  <svg xmlns="${U}" display="none">
  ${Object.entries(x).map(([e,t])=>(b.set(e,{viewBox:t.match(/viewBox="([^"]+)"/i)?.[1]}),t.replace(`xmlns="${U}"`,`id="sprite-${e}"`).replaceAll(/\bsvg\b/g,"symbol"))).join("")}
  </svg>
