...
`;var R=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 63 18">
...
`}return[a.map(l=>`%c${l}`).join(""),...p.map(l=>`background-color: ${l};`)]}var O1=q(),j1=()=>(setTimeout(async()=>{if(typeof window>"u"||typeof document>"u")return;let e=await G("images/artursjansons_32.jpg");$(...e)}),`
  ...
  `,Y=X1;var F1=({nonce:e})=>Object.entries({"script-src":[`'nonce-${e}'`,"'strict-dynamic'","https://www.google-analytics.com","https://ssl.google-analytics.com","https://static.hotjar.com","https://script.hotjar.com","https://js.sentry-cdn.com","'unsafe-inline'"],"img-src":["'self'","https://www.google-analytics.com","https://avatars.githubusercontent.com/","https://www.googletagmanager.com/","https://static.hotjar.com","https://survey-images.hotjar.com"],"connect-src":["'self'","https://www.google-analytics.com","https://region1.google-analytics.com","https://in.hotjar.com","wss://ws.hotjar.com","https://static.hotjar.com","https://content.hotjar.io","https://github.com/login/oauth/access_token","https://api.github.com/graphql","https://api.github.com/user","https://o171820.ingest.sentry.io/"],"style-src":[`'nonce-${e}'`,"https://static.hotjar.com"],"object-src":["'none'"],"base-uri":["'none'"],"frame-src":["https://vars.hotjar.com/"],"script-src-elem":[`'nonce-${e}'`,"'self'","https://script.hotjar.com"]}).reduce((t,[i,o])=>`${t};${i} ${o.join(" ")}`,"default-src 'self'"),W=({nonce:e})=>`<meta http-equiv="Content-Security-Policy" content="${F1({nonce:e})}">`;var m=({srcDoc:e,src:t,nonce:i,async:o,prefix:r,postfix:n,iife:s,crossorigin:c="",integrity:a})=>{let p=`${r||""}${e?v(e):""}${n||""}`;return`<script ${o?"async":""} crossorigin="${c}" ${a?`integrity="${a}"`:""} nonce="${i}" ${t?`src="${t}"`:""}>${s?`(${p})(${s})`:p}</script>`};var Q=({nonce:e,gtmId:t})=>`
