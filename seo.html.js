#!/usr/bin/env node
"use strict";var w1=Object.create;var P=Object.defineProperty;var v1=Object.getOwnPropertyDescriptor;var C1=Object.getOwnPropertyNames;var y1=Object.getPrototypeOf,L1=Object.prototype.hasOwnProperty;var x1=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports);var k1=(t,e,o,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of C1(e))!L1.call(t,i)&&i!==o&&P(t,i,{get:()=>e[i],enumerable:!(r=v1(e,i))||r.enumerable});return t};var b1=(t,e,o)=>(o=t!=null?w1(y1(t)):{},k1(e||!t||!t.__esModule?P(o,"default",{value:t,enumerable:!0}):o,t));var d1=x1((ue,e2)=>{e2.exports=`00000OOOO0000KKXXXKKKXXNNNNXKKKXXXXNNNXX
...
`});var k=b1(require("fs")),O=(t,e)=>k.writeFileSync(t,e,{encoding:"utf8"}),H=t=>k.readFileSync(t,{encoding:"utf8"});var D=new Date,M=`v3.1.0-${D.toJSON()}`,h=btoa(`${Number(D)}`).slice(10,18);var q=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 14 14" enable-background="new 0 0 240 240" x="0px" y="0px" xml:space="preserve" fill="currentColor">
...
`;var U=`<svg xmlns="https://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 16 16" data-view-component="true" fill="currentColor">
  <path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z"/>
</svg>
`;var V=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 63 18">
...
`;var B=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 124 124" fill="currentColor" fill-rule="evenodd">
...
`;var G=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 622 124" fill="currentColor" fill-rule="evenodd">
...
`;var J=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 46 33" stroke-width="1.8" fill="none" fill-rule="evenodd" stroke="currentColor">
...
</svg>`;var W=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 174 33" stroke-width="1.8" fill="none" fill-rule="evenodd" stroke="currentColor">
  <path d="M23.4888889,20.543316 C21.4404656,18.4187374 19.0750303,15.6666667 16.4832014,15.6666667 C13.8721947,15.6666667 11.7555556,17.6366138 11.7555556,20.0666667 C11.7555556,22.4967196 13.8721947,24.4666667 16.4832014,24.4666667 C18.8347252,24.4666667 19.9845474,23.0125628 20.6429148,22.312473" stroke-linecap="round"></path>
  <path d="M22.5111111,19.5900174 C24.5595344,21.7145959 26.9249697,24.4666667 29.5167986,24.4666667 C32.1278053,24.4666667 34.2444444,22.4967196 34.2444444,20.0666667 C34.2444444,17.6366138 32.1278053,15.6666667 29.5167986,15.6666667 C27.1652748,15.6666667 26.0154526,17.1207706 25.3570852,17.8208603" stroke-linecap="round"></path>
  <path d="M45,22.7331459 C45,19.1499462 42.7950446,16.079593 39.6628004,14.7835315 C39.6774469,14.5246474 39.7003932,14.2674038 39.7003932,14.0035978 C39.7003932,6.82243304 33.8412885,1 26.611593,1 C21.3985635,1 16.9102123,4.03409627 14.8051788,8.41527616 C13.7828502,7.62878013 12.503719,7.15547161 11.1134367,7.15547161 C7.77825654,7.15547161 5.07450503,9.84159999 5.07450503,13.1544315 C5.07450503,13.7760488 5.16938207,14.3779791 5.3477444,14.9418479 C2.74863428,16.4787471 1,19.2867709 1,22.5105187 C1,27.3287502 4.89630545,31.2367856 9.72803666,31.31094 L36.3341301,31.3109406 C41.1201312,31.3406346 45,27.4870665 45,22.7331459 L45,22.7331459 Z" stroke-linejoin="round"></path>
  <text x="50" y="28" font="bold 30px sans-serif" stroke="none" fill="currentColor">JSFiddle</text>
</svg>`;var Y=`<svg viewBox="0 0 62 39" fill="currentColor" xmlns="https://www.w3.org/2000/svg" class="main-header-logo">
...
`;var Q=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 258 39" fill="currentColor">
...
`;var t1=`<svg width="370" height="370" viewBox="0 0 370 370" fill="none" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink">
...
`;var S={"linkedin-icon":q,"linkedin-logo":z,"github-icon":U,"github-logo":V,"stackoverflow-icon":B,"stackoverflow-logo":G,"jsfiddle-icon":J,"jsfiddle-logo":W,"codersrank-icon":Y,"codersrank-logo":Q,"slot-machine-icon":t1};var e1="https://www.w3.org/2000/svg",N=new Map,I1=()=>`
  <svg xmlns="${e1}" display="none">
  ${Object.entries(S).map(([t,e])=>(N.set(t,{viewBox:e.match(/viewBox="([^"]+)"/i)?.[1]}),e.replace(`xmlns="${e1}"`,`id="sprite-${t}"`).replaceAll(/\bsvg\b/g,"symbol"))).join("")}
  </svg>
`,o1=I1;(()=>{if(typeof window>"u")return;document.write=window.write=()=>{},((e,o=[])=>Object.getOwnPropertyNames(e).forEach(r=>{let i=Object.prototype[r];o.includes(r)||Object.getOwnPropertyDescriptor(Object.prototype,r)?.configurable&&Object.defineProperty(Object.prototype,r,{configurable:!1,set:()=>{r!=="trace"&&console.trace(`Property "${r}" was changed in:`)},get:()=>i})}))(Object.prototype,["__proto__"]),window.satismeter=()=>{},window.requestAnimationFrame=window.requestAnimationFrame??(e=>{setTimeout(e)})})();var Z1=(t={})=>{let{className:e="",children:o,squire:r,tag:i="div"}=t,n="link-list";return e&&(n+=` ${e}`),r&&(n+=" link-list--squire"),`
      <${i} class="${n}">
        ${o?.map(c=>`<div class="link-list__item">${c}</div>`).join("")}
      </${i}>
    `},j=Z1;var T1=(t={})=>{let{className:e="link",children:o,tag:r="a",to:i="#",title:n="",onClick:c}=t,l=u();return setTimeout(()=>{c&&l.current&&l.current.addEventListener("click",c)}),`
      <${r} class="${e} link" href="${i}" title="${n}" ref="${l}">
        ${o?.join?.("")}
      </${r}>
    `},m=T1;var w="Page not found",X="Wrong request";var R=!1;var b=R?()=>{}:(...t)=>{console.debug(...t)};var $=R?()=>{}:(...t)=>{console.info(...t)},_=R?()=>{}:(...t)=>{console.log(...t)};var i1=`query RepoFile($repo_owner: String!, $repo_name: String!, $object_path: String!) {
...
# }`;var n1=`query GetUser($login:String!) {
  user(login: $login) {
    avatarUrl
    login
  }
}
`;var P1=async t=>{let{data:e,errors:o}=await t.json();if(o)throw o[0];return e},s1=class t{constructor(){this.repoName="iegik.github.com";this.repoOwner="iegik";this.storeRoot="gh-pages:data"}static{this.instance=new t}static getInstance(){return this.instance}async request({query:e,variables:o}){if(typeof window>"u")return;let r=window.sessionStorage?.getItem("access_token"),i=window.sessionStorage?.getItem("token_type"),n=await fetch("https://api.github.com/graphql",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json",Authorization:`${i} ${r}`},body:JSON.stringify({query:e,variables:o})});return P1(n)}async getFile(e){let o=await this.request({query:i1,variables:{repo_name:this.repoName,repo_owner:this.repoOwner,object_path:`${this.storeRoot}${e}.json`}});if(!o)throw Error(X);let{repository:{object:r}}=o;if(!r)throw Error(w);let{text:i}=r;return JSON.parse(i)}async getUserInfo(){let{user:e}=await this.request({query:n1,variables:{login:this.repoOwner}});if(!e)throw Error(X);return e}};var q1=t=>t.json(),a1=class t{static{this.instance=new t}constructor(){}static getInstance(){return this.instance}async request(e){let o=await fetch(`${location.protocol}//${location.host}/data${e}`,{headers:{"Content-Type":"application/json",Accept:"application/json"}});return q1(o)}async getFile(e){let o=await this.request(`${e}.json`);if(!o)throw Error(w);return o}};var I=class{constructor(){this.id=null}toString(){let e=btoa(`${Math.ceil(Math.random()*1e13)+ +new Date}`).slice(10,18);return this.id=this.id||`ref-${e}`}get current(){return typeof window>"u"||typeof document>"u"?null:document.querySelector(`[ref=${this.id}]`)}},u=()=>new I;var U1=({className:t,name:e}={name:"unknown"})=>{let o=u();return setTimeout(()=>{if(typeof window>"u"||typeof document>"u")return;let r=document.getElementById(`sprite-${e}`)?.getAttribute("viewBox")||"0 0 0 0";o.current?.setAttribute("viewBox",r)}),`
    <svg class="${t}" preserveAspectRatio="xMidYMid meet" viewBox="${N.get(e)?.viewBox||"0 0 0 0"}" ref="${o}">
      <use xlink:href="#sprite-${e}" />
    </svg>
  `},g=U1;var E=0,Z=!1,L="",l1=[],T="\u{1F34F},\u{1F330},\u{1F34B},\u{1F345},\u{1F346},\u{1F347},\u{1F353},\u{1F349},\u{1F350},\u{1F352},\u{1F351},\u{1F951}".split(","),{floor:V1,random:B1}=Math,G1=t=>t[V1(B1()*t.length)],A=()=>{if(Z)return L;let[t,e,o]=[T,T,T].flatMap(G1);if(L=`${t} ${e} ${o}`,b(`${E} ${L}`),t==e&&e==o){let r=`
            ${L}
    You won in ${E} tries`;Z=!0,l1.push(()=>{setTimeout(()=>{$(r),alert(r),Z=!1})}),E=0}else E++;return L},J1=()=>{let t=u();return setTimeout(()=>{if(typeof window>"u")return;let e=new MutationObserver((o,r)=>{for(let i of o)if(i.type==="childList"){let n=l1.pop();n&&n()}});t.current&&e.observe(t.current,{childList:!0}),t.current?.addEventListener("click",()=>{t.current&&(t.current.innerHTML=A())}),document.addEventListener("keydown",o=>{o.isComposing||o.keyCode===229||o.which!==13&&o.which!==32||t.current&&(t.current.innerHTML=A())})}),`
    <div class="slot-machine">
      ${g({name:"slot-machine-icon",className:"slot-machine__icon"})}
      <span class="slot-machine__reels" ref="${t}">${A()}</span>
    </div>
  `},K=J1;var W1={"image/webp":"webp","image/jpeg":"jpg","image/png":"png"},Y1={types:"",sizes:"",src:""},Q1=({types:t,sizes:e,src:o}=Y1)=>Object.entries(W1).filter(([r,i])=>t.includes(i)).flatMap(([r,i])=>`
    <source type="${r}" srcset="${e.split(",").map(n=>o.replace(new RegExp(`.(${t})$`),`_${n}.${i} ${n}w`))}" />
  `).join(""),t2=t=>{if(!t)return"";let{src:e,ratio:o,sizes:r,types:i="png|webp",alt:n="",itemprop:c=""}=t,[l,d]=o.split(":"),a=+r.split(",")[0],s=a*+l,p=a*+d;return`
    <picture>
      ${Q1({types:i,sizes:r,src:e})}
      <img src="${i.includes("webp")?e.replace(/\..*$/,".webp"):e}" width="${s}" height="${p}" alt="${n}" itemprop="${c}" />
    </picture>
  `},p1=t2;async function h1(t){let e=new Image;e.crossOrigin="Anonymous",e.src=t,await e.decode();let o=e.width,r=e.height,n=new OffscreenCanvas(o,r).getContext("2d");if(!n)return[];n.drawImage(e,0,0,o,r);let c=n.getImageData(0,0,o,r).data,l="\u2802\u2802\u2802\u2802\u2801\u2880\u2881\u2881\u288C\u288C\u2895\u2895\u2897\u2897\u289F\u289F\u28B7\u28B7\u28BF\u28BF",d=[],a=[];for(let s=0;s<r;s++){for(let p=0;p<o;p++){let f=(s*o+p)*4,x=c[f],v=c[f+1],C=c[f+2];if(c[f+3]===0)continue;let u1=(x+v+C)/3,F=Math.floor((1-u1/255)*10);d.push(l[F*2]+l[F*2+1]),a.push(`#${x.toString(16).padStart(2,"0")}${v.toString(16).padStart(2,"0")}${C.toString(16).padStart(2,"0")}`)}d[d.length-1]+=`
`}return[d.map(s=>`%c${s}`).join(""),...a.map(s=>`background-color: ${s};`)]}var o2=d1(),r2=()=>(setTimeout(async()=>{if(typeof window>"u"||typeof document>"u")return;let t=await h1("images/artursjansons_32.jpg");_(...t)}),`
    <header class="header">
      <a href="#/home" class="header__avatar" alt="avatar">${p1({itemprop:"photo",src:"/images/artursjansons.jpg",ratio:"1:1",sizes:"432,216,64",types:"jpg|png|webp",alt:o2})}</a>
    </header>
  `),m1=r2;var i2=t=>()=>{if(typeof window>"u")return;let e=typeof window>"u"?!1:window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches===!0,o,r,i,n,c=16,l,d,a=document?.querySelector(t),s=document?.documentElement,p=a&&s&&Math.max(a.scrollWidth,a.offsetWidth,s.clientWidth,s.scrollWidth,s.offsetWidth),f=a&&s&&Math.max(a.scrollHeight,a.offsetHeight,s.clientHeight,s.scrollHeight,s.offsetHeight);o=r=i=n=0,p&&p>300&&addEventListener("mousemove",function(C){i=C.pageX,n=C.pageY});function x(){o-=.5,r-=5,!(f==null||p==null)&&(d=`${p/2-2762-i/(5*c)}px ${f-129+(20-n)/(10*c)}px, ${(o-i)/(10*c)}px 60%, ${(r-i)/c}px 40%`)}function v(){x(),a?.style&&(a.style.backgroundPosition=d,l&&window.cancelAnimationFrame(l),l=window.requestAnimationFrame(v))}!e&&v()},n2=()=>(setTimeout(i2("#clouds")),`
    <div id="clouds"></div>
  `),g1=n2;var s2=()=>`
    ${g1()}
    ${m1()}
    <article lang="en">
      <section id="home" itemscope itemtype="https://schema.org/Person">
        <header>
          ...
          ${j({squire:!0,children:[m({to:"https://linkedin.com/in/iegik",title:"LinkedIn",children:[g({name:"linkedin-icon",className:"link-list__icon"})]}),m({to:"https://github.com/iegik",title:"GitHub",children:[g({name:"github-icon",className:"link-list__icon"})]}),m({to:"https://profile.codersrank.io/user/iegik",title:"Coders Rank",children:[g({name:"codersrank-icon",className:"link-list__icon"})]}),m({to:"https://jsfiddle.net/user/iegik",title:"JSFiddle",children:[g({name:"jsfiddle-icon",className:"link-list__icon"})]}),m({to:"https://stackoverflow.com/users/771471/iegik",title:"Stack Overflow",children:[g({name:"stackoverflow-icon",className:"link-list__icon"})]})]})}
...
<html lang="en" manifest="manifest.appcache">
  <head>
    ...
    <style nonce="${h}">${c2}</style>
  </head>
  <body>
    <noscript>This page uses JavaScript to play the slot machine game.</noscript>
    ${o1()}
    <div id="root">${f1()}</div>
    <script defer nonce="${h}" src="/lib/router.min.js"></script>
    
    <script async nonce="${h}" src="https://www.googletagmanager.com/gtag/js?id=G-5ZY8Y6X2C4"></script>
    <script nonce="${h}">
    ...
    <script nonce="${h}" src="https://browser.sentry-cdn.com/7.54.0/bundle.min.js" integrity="sha384-EmlJLN9Q0yu0/2UUCIYnEM88jpQ7xUhtNI2ZeXb/ci3cwoAoIQl350N4PQPlMbP5" crossorigin="anonymous"></script>
    <script nonce="${h}">
