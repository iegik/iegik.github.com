...
c:oOXXK0Oxlkk;.,;;;...O0OO;.
;kXK0Okxxlxxk:.',,'..,xxkxx 
`});var y=y1(require("fs")),x=(e,t)=>y.writeFileSync(e,t,{encoding:"utf8"}),L=e=>y.readFileSync(e,{encoding:"utf8"});var N=new Date,$=`v3.1.0-${N.toJSON()}`,g=btoa(`${Number(N)}`).slice(10,18);var T=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 14 14" enable-background="new 0 0 240 240" x="0px" y="0px" xml:space="preserve" fill="currentColor">
...
`;var X=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 124 124" fill="currentColor" fill-rule="evenodd">
...
`;var K=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 622 124" fill="currentColor" fill-rule="evenodd">
...
`;var D=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 46 33" stroke-width="1.8" fill="none" fill-rule="evenodd" stroke="currentColor">
...
`;var B=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 258 39" fill="currentColor">
...
`,G=P1;(()=>{if(typeof window>"u")return;document.write=window.write=()=>{},((t,o=[])=>Object.getOwnPropertyNames(t).forEach(r=>{let i=Object.prototype[r];o.includes(r)||Object.getOwnPropertyDescriptor(Object.prototype,r)?.configurable&&Object.defineProperty(Object.prototype,r,{configurable:!1,set:()=>{r!=="trace"&&console.trace(`Property "${r}" was changed in:`)},get:()=>i})}))(Object.prototype,["__proto__"]),window.satismeter=()=>{},window.requestAnimationFrame=window.requestAnimationFrame??(t=>{setTimeout(t)})})();var _1={"image/webp":"webp","image/jpeg":"jpg","image/png":"png"},I1={types:"",sizes:"",src:""},N1=({types:e,sizes:t,src:o}=I1)=>Object.entries(_1).filter(([r,i])=>e.includes(i)).flatMap(([r,i])=>`
  ...
  `},U=T1;var Z1=(e={})=>{let{className:t="",children:o,squire:r,tag:i="div"}=e,n="link-list";return t&&(n+=` ${t}`),r&&(n+=" link-list--squire"),`
    ...
    `},S=Z1;var f="Page not found",E="Wrong request";var Y=`query RepoFile($repo_owner: String!, $repo_name: String!, $object_path: String!) {
...
`;var X1=async e=>{let{data:t,errors:o}=await e.json();if(o)throw o[0];return t},W=class e{constructor(){this.repoName="iegik.github.com";this.repoOwner="iegik";this.storeRoot="gh-pages:data"}static{this.instance=new e}static getInstance(){return this.instance}async request({query:t,variables:o}){if(typeof window>"u")return;let r=window.sessionStorage?.getItem("access_token"),i=window.sessionStorage?.getItem("token_type"),n=await fetch("https://api.github.com/graphql",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json",Authorization:`${i} ${r}`},body:JSON.stringify({query:t,variables:o})});return X1(n)}async getFile(t){let o=await this.request({query:Y,variables:{repo_name:this.repoName,repo_owner:this.repoOwner,object_path:`${this.storeRoot}${t}.json`}});if(!o)throw Error(E);let{repository:{object:r}}=o;if(!r)throw Error(f);let{text:i}=r;return JSON.parse(i)}async getUserInfo(){let{user:t}=await this.request({query:Q,variables:{login:this.repoOwner}});if(!t)throw Error(E);return t}};var H1=e=>e.json(),e1=class e{static{this.instance=new e}constructor(){}static getInstance(){return this.instance}async request(t){let o=await fetch(`${location.protocol}//${location.host}/data${t}`,{headers:{"Content-Type":"application/json",Accept:"application/json"}});return H1(o)}async getFile(t){let o=await this.request(`${t}.json`);if(!o)throw Error(f);return o}};var z1=({className:e,name:t}={name:"unknown"})=>{let o=u();return setTimeout(()=>{if(typeof window>"u"||typeof document>"u")return;let r=document.getElementById(`sprite-${t}`)?.getAttribute("viewBox")||"0 0 0 0";o.current?.setAttribute("viewBox",r)}),`
...
<html lang="en" manifest="manifest.appcache">
  <head>
    ...
    <title>${e2}</title>
    <meta name="description" content="${o2}" />
    <meta http-equiv="Content-type" content="text/html; charset=UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="theme-color" content="var(--color-primary-light)" />
    <style nonce="${g}">${t2}</style>
    
    ${l1({nonce:g,gtmId:"GTM-MBG56M"})}
  </head>
  <body>
...
NETWORK:
*
`;x("public/next/manifest.appcache",i2);
