...
`;var Ce=()=>`
  ...
  `,le=Ue;var y=e=>te({children:["Loading..."],...e}),qe=(e="/")=>{switch(c(`Loading ${e}`),!0){case/^\/login\/?$/.test(e):return le();case/^\/oauth\/?$/.test(e):return y({services:["oauth"]});case/^\/profile\/?$/.test(e):return y({services:["preview"]});case/^\/editor\/?$/.test(e):return y({services:["editor"]});case/^\/preview\/?$/.test(e):return y({services:["preview"]});case(e==="/"||e===""):return ae();default:throw Error(p)}},Ae=e=>{let{error:t}=e;x(t)},He=e=>{let t=w(e);if(typeof window!="undefined"&&window?.document){addEventListener("error",Ae);let o=document.getElementById("root");if(o==null)return;o.innerHTML=qe(t)}};He();})();
