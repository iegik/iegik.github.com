#!/usr/bin/env node
"use strict";var Re=Object.create;var I=Object.defineProperty;var Ie=Object.getOwnPropertyDescriptor;var De=Object.getOwnPropertyNames;var Oe=Object.getPrototypeOf,Ae=Object.prototype.hasOwnProperty;var _e=(e,t)=>{for(var o in t)I(e,o,{get:t[o],enumerable:!0})},Ne=(e,t,o,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of De(t))!Ae.call(e,n)&&n!==o&&I(e,n,{get:()=>t[n],enumerable:!(r=Ie(t,n))||r.enumerable});return e};var Ge=(e,t,o)=>(o=e!=null?Re(Oe(e)):{},Ne(t||!e||!e.__esModule?I(o,"default",{value:e,enumerable:!0}):o,e));var F=Ge(require("fs")),y=(e,t)=>F.writeFileSync(e,t,{encoding:"utf8"}),u=e=>F.readFileSync(e,{encoding:"utf8"});var te=new Date,D=`v3.1.1-${te.toJSON()}`,s=btoa(`${Number(te)}`).slice(10,18);var g=e=>`<a ${/^http/.test(e.href)?' rel="noopener noreferrer"':""} href="${e.href}" title="${e.title}">${e.title}</a>`;var h=e=>e.replace(/[&<"']/g,t=>{switch(t){case"&":return"&amp;";case"<":return"&lt;";case'"':return"&quot;";default:return"&#039;"}});var M=({src:e,ascii:t})=>`<pre><font size=1><img width="128" height="128" src="${e}" alt="${h(u(t))}" /></font></pre>`;var O=({src:e,title:t})=>`<fieldset bgcolor="green">
                                                <legend>${t}</legend>
...
`;var oe=({nonce:e,integrity:t,projectId:o,...r})=>`
    ${a({async:!0,nonce:e,src:"https://browser.sentry-cdn.com/8.51.0/bundle.tracing.replay.debug.min.js",integrity:t,crossorigin:"anonymous"})}
