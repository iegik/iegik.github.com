#!/usr/bin/env node
var w1=Object.create,y=Object.defineProperty,v1=Object.getPrototypeOf,x1=Object.prototype.hasOwnProperty,C1=Object.getOwnPropertyNames,L1=Object.getOwnPropertyDescriptor;var y1=e=>y(e,"__esModule",{value:!0});var k1=(e,t)=>()=>(t||(t={exports:{}},e(t.exports,t)),t.exports);var b1=(e,t,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of C1(t))!x1.call(e,i)&&i!=="default"&&y(e,i,{get:()=>t[i],enumerable:!(o=L1(t,i))||o.enumerable});return e},$1=e=>b1(y1(y(e!=null?w1(v1(e)):{},"default",e&&e.__esModule&&"default"in e?{get:()=>e.default,enumerable:!0}:{value:e,enumerable:!0})),e);var d1=k1((vt,p1)=>{p1.exports=`dxxddddddddxxdddxxxxkkkxxk
dxdddddddddd:lxxxxxxxkkkxx
ddddddddddxoocdxxxxxxkkkkk
dddddddddO000kkxdxxdxxxkkk
ddddddddO000OOOkxlodddxxxk
dddddddkdloxOdlcooccdddxxk
dddddodOOOOkkoxkkdc.:dxxxx
ddddl,,xxodddlccl:.',;dddx
dxdl,',;clkxxxO0Ox;'',;loo
xxl',,;,:odoKxOxdd'''',,lo
xo'',';;d0Okkll;,'.'',,,;o
ddxxxxxdxOkxxdoodddddddddd
ddodxkkkkkkkkkkkkkxdoooood
`});var v=$1(require("fs")),k=(e,t)=>v.writeFileSync(e,t,{encoding:"utf8"}),H=e=>v.readFileSync(e,{encoding:"utf8"});var q=new Date,b=`v3.1.0-${q.toJSON()}`,p=btoa(`${Number(q)}`).slice(10,18);var z=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 14 14" enable-background="new 0 0 240 240" x="0px" y="0px" xml:space="preserve" fill="currentColor">
...
`;var $={"linkedin-icon":z,"linkedin-logo":D,"github-icon":U,"github-logo":V,"stackoverflow-icon":B,"stackoverflow-logo":G,"jsfiddle-icon":J,"jsfiddle-logo":W,"codersrank-icon":Y,"codersrank-logo":Q,"slot-machine-icon":K};var X="https://www.w3.org/2000/svg",E=new Map,E1=()=>`
  <svg xmlns="${X}" display="none">
  ${Object.entries($).map(([e,t])=>(E.set(e,{viewBox:t.match(/viewBox="([^"]+)"/i)?.[1]}),t.replace(`xmlns="${X}"`,`id="sprite-${e}"`).replaceAll(/\bsvg\b/g,"symbol"))).join("")}
  </svg>
`,e1=E1;(()=>{typeof window!="undefined"&&(window.requestAnimationFrame=window.requestAnimationFrame??(e=>{setTimeout(e)}))})();var M1=(e={})=>{let{className:t="",children:o,squire:i,tag:r="div"}=e,n="link-list";return t&&(n+=` ${t}`),i&&(n+=" link-list--squire"),`
      <${r} class="${n}">
        ${o?.map(s=>`<div class="link-list__item">${s}</div>`).join("")}
      </${r}>
    `},M=M1;var S1=(e={})=>{let{className:t="link",children:o,tag:i="a",to:r="#",title:n="",onClick:s}=e,l=h();return setTimeout(()=>{s&&l.current&&l.current.addEventListener("click",s)}),`
      <${i} class="${t} link" href="${r}" title="${n}" ref="${l}">
        ${o?.join?.("")}
      </${i}>
    `},d=S1;var f="Page not found",S="Wrong request";var R=!1;var x=R?()=>{}:(...e)=>{console.debug(...e)};var C=R?()=>{}:(...e)=>{console.info(...e)},_=R?()=>{}:(...e)=>{console.log(...e)};var o1=`query RepoFile($repo_owner: String!, $repo_name: String!, $object_path: String!) {
...
`;var R1=async e=>{let{data:t,errors:o}=await e.json();if(o)throw o[0];return t},O=class{constructor(){this.repoName="iegik.github.com";this.repoOwner="iegik";this.storeRoot="gh-pages:data"}static getInstance(){return this.instance}async request({query:t,variables:o}){if(typeof window=="undefined")return;let i=window.sessionStorage?.getItem("access_token"),r=window.sessionStorage?.getItem("token_type"),n=await fetch("https://api.github.com/graphql",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json",Authorization:`${r} ${i}`},body:JSON.stringify({query:t,variables:o})});return R1(n)}async getFile(t){let o=await this.request({query:o1,variables:{repo_name:this.repoName,repo_owner:this.repoOwner,object_path:`${this.storeRoot}${t}.json`}});if(!o)throw Error(S);let{repository:{object:i}}=o;if(!i)throw Error(f);let{text:r}=i;return JSON.parse(r)}async getUserInfo(){let{user:t}=await this.request({query:i1,variables:{login:this.repoOwner}});if(!t)throw Error(S);return t}},r1=O;r1.instance=new O;var j1=e=>e.json(),j=class{constructor(){}static getInstance(){return this.instance}async request(t){let o=await fetch(`${location.protocol}//${location.host}/data${t}`,{headers:{"Content-Type":"application/json",Accept:"application/json"}});return j1(o)}async getFile(t){let o=await this.request(`${t}.json`);if(!o)throw Error(f);return o}},s1=j;s1.instance=new j;var c1=class{constructor(){this.id=null}toString(){let t=btoa(`${Math.ceil(Math.random()*1e13)+ +new Date}`).slice(10,18);return this.id=this.id||`ref-${t}`}get current(){return typeof window=="undefined"||typeof document=="undefined"?null:document.querySelector(`[ref=${this.id}]`)}},h=()=>new c1;var I1=({className:e,name:t}={name:"unknown"})=>{let o=h();return setTimeout(()=>{if(typeof window=="undefined"||typeof document=="undefined")return;let i=document.getElementById(`sprite-${t}`)?.getAttribute("viewBox")||"0 0 0 0";o.current?.setAttribute("viewBox",i)}),`
    <svg class="${e}" preserveAspectRatio="xMidYMid meet" viewBox="${E.get(t)?.viewBox||"0 0 0 0"}" ref="${o}">
      <use xlink:href="#sprite-${t}" />
    </svg>
  `},m=I1;var L=0,I=!1,u="",a1=[],A="\u{1F34F},\u{1F330},\u{1F34B},\u{1F345},\u{1F346},\u{1F347},\u{1F353},\u{1F349},\u{1F350},\u{1F352},\u{1F351},\u{1F951}".split(","),{floor:A1,random:T1}=Math,F1=e=>e[A1(T1()*e.length)],T=()=>{if(I)return u;let[e,t,o]=[A,A,A].flatMap(F1);if(u=`${e} ${t} ${o}`,x(`${L} ${u}`),e==t&&t==o){let i=`
            ${u}
    You won in ${L} tries`;I=!0,a1.push(()=>{setTimeout(()=>{C(i),alert(i),I=!1})}),L=0}else L++;return u},N1=()=>{let e=h();return setTimeout(()=>{if(typeof window=="undefined")return;let t=new MutationObserver((o,i)=>{for(let r of o)if(r.type==="childList"){let n=a1.pop();n&&n()}});e.current&&t.observe(e.current,{childList:!0}),e.current?.addEventListener("click",()=>{!e.current||(e.current.innerHTML=T())}),document.addEventListener("keydown",o=>{o.isComposing||o.keyCode===229||o.which!==13&&o.which!==32||!e.current||(e.current.innerHTML=T())})}),`
    <div class="slot-machine">
      ${m({name:"slot-machine-icon",className:"slot-machine__icon"})}
      <span class="slot-machine__reels" ref="${e}">${T()}</span>
    </div>
  `},Z=N1;var P1={"image/webp":"webp","image/jpeg":"jpg","image/png":"png"},H1={types:"",sizes:"",src:""},q1=({types:e,sizes:t,src:o}=H1)=>Object.entries(P1).filter(([i,r])=>e.includes(r)).flatMap(([i,r])=>`
    <source type="${i}" srcset="${t.split(",").map(n=>o.replace(new RegExp(`.(${e})$`),`_${n}.${r} ${n}w`))}" />
  `).join(""),z1=e=>{if(!e)return"";let{src:t,ratio:o,sizes:i,types:r="png|webp",alt:n="",itemprop:s=""}=e,[l,w]=o.split(":"),c=+i.split(",")[0],a=c*+l,g=c*+w;return`
    <picture>
      ${q1({types:r,sizes:i,src:t})}
      <img src="${r.includes("webp")?t.replace(/\..*$/,".webp"):t}" width="${a}" height="${g}" alt="${n}" itemprop="${s}" />
    </picture>
  `},l1=z1;var m1=d1(),D1=()=>(setTimeout(()=>{_(m1)}),`
    <header class="header">
      <a href="#home" class="header__avatar" alt="avatar">${l1({itemprop:"photo",src:"/images/artursjansons.jpg",ratio:"1:1",sizes:"432,216,64",types:"jpg|png|webp",alt:m1})}</a>
    </header>
  `),h1=D1;var U1=e=>()=>{if(typeof window=="undefined")return;let t=typeof window=="undefined"?!1:window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches===!0,o,i,r,n,s=16,l,w,c=document?.querySelector(e),a=document?.documentElement,g=c&&a&&Math.max(c.scrollWidth,c.offsetWidth,a.clientWidth,a.scrollWidth,a.offsetWidth),F=c&&a&&Math.max(c.scrollHeight,c.offsetHeight,a.clientHeight,a.scrollHeight,a.offsetHeight);o=i=r=n=0,g&&g>300&&addEventListener("mousemove",function(P){r=P.pageX,n=P.pageY});function u1(){o-=.5,i-=5,!(F==null||g==null)&&(w=`${g/2-2762-r/(5*s)}px ${F-129+(20-n)/(10*s)}px, ${(o-r)/(10*s)}px 60%, ${(i-r)/s}px 40%`)}function N(){u1(),!!c?.style&&(c.style.backgroundPosition=w,l&&window.cancelAnimationFrame(l),l=window.requestAnimationFrame(N))}!t&&N()},V1=()=>(setTimeout(U1("#clouds")),`
    <div id="clouds"></div>
  `),g1=V1;var B1=()=>`
    ${g1()}
    ${h1()}
    <article lang="en">
      <section id="home" itemscope itemtype="https://schema.org/Person">
        <header>
          ...
          ${M({squire:!0,children:[d({to:"https://linkedin.com/in/iegik",title:"LinkedIn",children:[m({name:"linkedin-icon",className:"link-list__icon"})]}),d({to:"https://github.com/iegik",title:"GitHub",children:[m({name:"github-icon",className:"link-list__icon"})]}),d({to:"https://profile.codersrank.io/user/iegik",title:"Coders Rank",children:[m({name:"codersrank-icon",className:"link-list__icon"})]}),d({to:"https://jsfiddle.net/user/iegik",title:"JSFiddle",children:[m({name:"jsfiddle-icon",className:"link-list__icon"})]}),d({to:"https://stackoverflow.com/users/771471/iegik",title:"Stack Overflow",children:[m({name:"stackoverflow-icon",className:"link-list__icon"})]})]})}
...
<html lang="en" manifest="manifest.appcache">
  ...
  <body>
    ...
    <script nonce="${p}" src="https://browser.sentry-cdn.com/7.54.0/bundle.min.js" integrity="sha384-EmlJLN9Q0yu0/2UUCIYnEM88jpQ7xUhtNI2ZeXb/ci3cwoAoIQl350N4PQPlMbP5" crossorigin="anonymous"></script>
    <script nonce="${p}">
