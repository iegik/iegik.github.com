#!/usr/bin/env node
var i1=Object.create,g=Object.defineProperty,n1=Object.getPrototypeOf,s1=Object.prototype.hasOwnProperty,c1=Object.getOwnPropertyNames,a1=Object.getOwnPropertyDescriptor;var l1=t=>g(t,"__esModule",{value:!0});var p1=(t,e)=>()=>(e||(e={exports:{}},t(e.exports,e)),e.exports);var d1=(t,e,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of c1(e))!s1.call(t,r)&&r!=="default"&&g(t,r,{get:()=>e[r],enumerable:!(o=a1(e,r))||o.enumerable});return t},m1=t=>d1(l1(g(t!=null?i1(n1(t)):{},"default",t&&t.__esModule&&"default"in t?{get:()=>t.default,enumerable:!0}:{value:t,enumerable:!0})),t);var Y=p1((oe,X)=>{X.exports=`XOddodddddddodxxxxxxxdddxxxxxkxxxOKKKOdloo
...
`});var h=m1(require("fs")),f=(t,e)=>h.writeFileSync(t,e,{encoding:"utf8"}),$=t=>h.readFileSync(t,{encoding:"utf8"});var E=new Date,u=`v3.1.0-${E.toJSON()}`,s=btoa(`${Number(E)}`).slice(10,18);var M=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 14 14" enable-background="new 0 0 240 240" x="0px" y="0px" xml:space="preserve" fill="currentColor">
...
`;var S=`<svg xmlns="https://www.w3.org/2000/svg" enable-background="new 0 0 55.2 14" version="1.1" viewBox="0 0 55.2 14" xml:space="preserve"  fill="currentColor">
...
`;var O=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 63 18">
...
`;var _=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 124 124" fill="currentColor" fill-rule="evenodd">
...
`;var j=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 622 124" fill="currentColor" fill-rule="evenodd">
...
</svg>`;var I=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 174 33" stroke-width="1.8" fill="none" fill-rule="evenodd" stroke="currentColor">
  <path d="M23.4888889,20.543316 C21.4404656,18.4187374 19.0750303,15.6666667 16.4832014,15.6666667 C13.8721947,15.6666667 11.7555556,17.6366138 11.7555556,20.0666667 C11.7555556,22.4967196 13.8721947,24.4666667 16.4832014,24.4666667 C18.8347252,24.4666667 19.9845474,23.0125628 20.6429148,22.312473" stroke-linecap="round"></path>
  <path d="M22.5111111,19.5900174 C24.5595344,21.7145959 26.9249697,24.4666667 29.5167986,24.4666667 C32.1278053,24.4666667 34.2444444,22.4967196 34.2444444,20.0666667 C34.2444444,17.6366138 32.1278053,15.6666667 29.5167986,15.6666667 C27.1652748,15.6666667 26.0154526,17.1207706 25.3570852,17.8208603" stroke-linecap="round"></path>
  <path d="M45,22.7331459 C45,19.1499462 42.7950446,16.079593 39.6628004,14.7835315 C39.6774469,14.5246474 39.7003932,14.2674038 39.7003932,14.0035978 C39.7003932,6.82243304 33.8412885,1 26.611593,1 C21.3985635,1 16.9102123,4.03409627 14.8051788,8.41527616 C13.7828502,7.62878013 12.503719,7.15547161 11.1134367,7.15547161 C7.77825654,7.15547161 5.07450503,9.84159999 5.07450503,13.1544315 C5.07450503,13.7760488 5.16938207,14.3779791 5.3477444,14.9418479 C2.74863428,16.4787471 1,19.2867709 1,22.5105187 C1,27.3287502 4.89630545,31.2367856 9.72803666,31.31094 L36.3341301,31.3109406 C41.1201312,31.3406346 45,27.4870665 45,22.7331459 L45,22.7331459 Z" stroke-linejoin="round"></path>
  <text x="50" y="28" font="bold 30px sans-serif" stroke="none" fill="currentColor">JSFiddle</text>
</svg>`;var N=`<svg viewBox="0 0 62 39" fill="currentColor" xmlns="https://www.w3.org/2000/svg" class="main-header-logo">
...
`;var A=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 258 39" fill="currentColor">
...
`;var w={"linkedin-icon":M,"linkedin-logo":S,"github-icon":R,"github-logo":O,"stackoverflow-icon":_,"stackoverflow-logo":j,"jsfiddle-icon":Z,"jsfiddle-logo":I,"codersrank-icon":N,"codersrank-logo":A,"slot-machine-icon":F};var T="https://www.w3.org/2000/svg",v=new Map,h1=()=>`
  <svg xmlns="${T}" display="none">
  ${Object.entries(w).map(([t,e])=>(v.set(t,{viewBox:e.match(/viewBox="([^"]+)"/i)?.[1]}),e.replace(`xmlns="${T}"`,`id="sprite-${t}"`).replaceAll(/\bsvg\b/g,"symbol"))).join("")}
  </svg>
`,P=h1;var g1={"image/webp":"webp","image/jpeg":"jpg","image/png":"png"},f1={types:"",sizes:"",src:""},u1=({types:t,sizes:e,src:o}=f1)=>Object.entries(g1).filter(([r,i])=>t.includes(i)).flatMap(([r,i])=>`
    <source type="${r}" srcset="${e.split(",").map(n=>o.replace(new RegExp(`.(${t})$`),`_${n}.${i} ${n}w`))}" />
  `).join(""),w1=t=>{if(!t)return"";let{src:e,ratio:o,sizes:r,types:i="png|webp",alt:n="",itemprop:l=""}=t,[m,t1]=o.split(":"),b=+r.split(",")[0],o1=b*+m,r1=b*+t1;return`
    <picture>
      ${u1({types:i,sizes:r,src:e})}
      <img src="${i.includes("webp")?e.replace(/\..*$/,".webp"):e}" width="${o1}" height="${r1}" alt="${n}" itemprop="${l}" />
    </picture>
  `},H=w1;var v1=(t={})=>{let{className:e="",children:o,squire:r,tag:i="div"}=t,n="link-list";return e&&(n+=` ${e}`),r&&(n+=" link-list--squire"),`
      <${i} class="${n}">
        ${o?.map(l=>`<div class="link-list__item">${l}</div>`).join("")}
      </${i}>
    `},x=v1;var p="Page not found",C="Wrong request";var D=`query RepoFile($repo_owner: String!, $repo_name: String!, $object_path: String!) {
...
# }`;var U=`query GetUser($login:String!) {
  user(login: $login) {
    avatarUrl
    login
  }
}
`;var x1=async t=>{let{data:e,errors:o}=await t.json();if(o)throw o[0];return e},k=class{constructor(){this.repoName="iegik.github.com";this.repoOwner="iegik";this.storeRoot="gh-pages:data"}static getInstance(){return this.instance}async request({query:e,variables:o}){if(typeof window=="undefined")return;let r=window.sessionStorage?.getItem("access_token"),i=window.sessionStorage?.getItem("token_type"),n=await fetch("https://api.github.com/graphql",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json",Authorization:`${i} ${r}`},body:JSON.stringify({query:e,variables:o})});return x1(n)}async getFile(e){let o=await this.request({query:D,variables:{repo_name:this.repoName,repo_owner:this.repoOwner,object_path:`${this.storeRoot}${e}.json`}});if(!o)throw Error(C);let{repository:{object:r}}=o;if(!r)throw Error(p);let{text:i}=r;return JSON.parse(i)}async getUserInfo(){let{user:e}=await this.request({query:U,variables:{login:this.repoOwner}});if(!e)throw Error(C);return e}},q=k;q.instance=new k;var L1=t=>t.json(),L=class{constructor(){}static getInstance(){return this.instance}async request(e){let o=await fetch(`${location.protocol}//${location.host}/data${e}`,{headers:{"Content-Type":"application/json",Accept:"application/json"}});return L1(o)}async getFile(e){let o=await this.request(`${e}.json`);if(!o)throw Error(p);return o}},B=L;B.instance=new L;var y1=({className:t,name:e}={name:"unknown"})=>{let o=d();return setTimeout(()=>{if(typeof window=="undefined"||typeof document=="undefined")return;let r=document.getElementById(`sprite-${e}`)?.getAttribute("viewBox")||"0 0 0 0";o.current?.setAttribute("viewBox",r)}),`
    <svg class="${t}" preserveAspectRatio="xMidYMid meet" viewBox="${v.get(e)?.viewBox||"0 0 0 0"}" ref="${o}">
      <use xlink:href="#sprite-${e}" />
    </svg>
  `},a=y1;var C0="\u{1F34F},\u{1F330},\u{1F34B},\u{1F345},\u{1F346},\u{1F347},\u{1F353},\u{1F349},\u{1F350},\u{1F352},\u{1F351},\u{1F951}".split(",");var G=class{constructor(){this.id=null}toString(){let e=btoa(`${Math.ceil(Math.random()*1e13)+ +new Date}`).slice(10,18);return this.id=this.id||`ref-${e}`}get current(){return typeof window=="undefined"||typeof document=="undefined"?null:document.querySelector(`[ref=${this.id}]`)}},d=()=>new G;var $1=(t={})=>{let{className:e="link",children:o,tag:r="a",to:i="#",title:n="",onClick:l}=t,m=d();return setTimeout(()=>{l&&m.current&&m.current.addEventListener("click",l)}),`
      <${r} class="${e} link" href="${i}" title="${n}" ref="${m}">
        ${o?.join?.("")}
      </${r}>
    `},c=$1;var E1=!1;var y=E1?()=>{}:(...t)=>{console.log(...t)};var Q=Y(),M1=()=>(setTimeout(()=>{y(Q)}),`
    <header class="header">
      <a href="#home" class="header__avatar" alt="avatar">${H({itemprop:"photo",src:"/images/artursjansons.jpg",ratio:"1:1",sizes:"432,216,64",types:"jpg|png|webp",alt:Q})}</a>
    </header>
  `),W=M1;var S1=()=>`
    ${W()}
    <article lang="en">
...
<html lang="en" manifest="manifest.appcache">
  ...
  <body>
    ...
    <script nonce="${s}" src="https://browser.sentry-cdn.com/7.7.0/bundle.min.js" integrity="sha384-EmlJLN9Q0yu0/2UUCIYnEM88jpQ7xUhtNI2ZeXb/ci3cwoAoIQl350N4PQPlMbP5" crossorigin="anonymous"></script>
    <script nonce="${s}">
