#!/usr/bin/env node
"use strict";var c1=Object.create;var _=Object.defineProperty;var a1=Object.getOwnPropertyDescriptor;var l1=Object.getOwnPropertyNames;var p1=Object.getPrototypeOf,h1=Object.prototype.hasOwnProperty;var d1=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var m1=(e,t,o,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of l1(t))!h1.call(e,i)&&i!==o&&_(e,i,{get:()=>t[i],enumerable:!(r=a1(t,i))||r.enumerable});return e};var g1=(e,t,o)=>(o=e!=null?c1(p1(e)):{},m1(t||!e||!e.__esModule?_(o,"default",{value:e,enumerable:!0}):o,e));var r1=d1((e0,z1)=>{z1.exports=`0000OOO00KXXXKKXNNXKKKXXNNNX
OOOOOOO000KKXKXNNNXKKXNNNNNN
XXKXKKKKKKKKKKXXNXXXXNNXXXNX
XKKKKXNXXKK0kodxkOKXXXXXXKXX
oooddxkkkkdlccodocok00000000
::::c:::ccclclloloccooooxkkO
;,,,,;;;;;lccccclloll:::codx
,,,,,,,,,,c;';c,',:olc::clol
'''''''''':c::ll;;ccc;,,,,,;
'.'.......'c;;,,,,,::;,,,,,,
...
c:oOXXK0Oxlkk;.,;;;...O0OO;.
;kXK0Okxxlxxk:.',,'..,xxkxx 
`});var C=g1(require("fs")),L=(e,t)=>C.writeFileSync(e,t,{encoding:"utf8"}),N=e=>C.readFileSync(e,{encoding:"utf8"});var I=new Date,y=`v3.1.0-${I.toJSON()}`,a=btoa(`${Number(I)}`).slice(10,18);var Z=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 14 14" enable-background="new 0 0 240 240" x="0px" y="0px" xml:space="preserve" fill="currentColor">
...
`;var A=`<svg xmlns="https://www.w3.org/2000/svg" enable-background="new 0 0 55.2 14" version="1.1" viewBox="0 0 55.2 14" xml:space="preserve"  fill="currentColor">
...
`;var T=`<svg xmlns="https://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 16 16" data-view-component="true" fill="currentColor">
  <path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z"/>
</svg>
`;var F=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 63 18">
...
`;var P=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 124 124" fill="currentColor" fill-rule="evenodd">
...
`;var X=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 622 124" fill="currentColor" fill-rule="evenodd">
...
`;var K=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 46 33" stroke-width="1.8" fill="none" fill-rule="evenodd" stroke="currentColor">
...
</svg>`;var z=`<svg viewBox="0 0 62 39" fill="currentColor" xmlns="https://www.w3.org/2000/svg" class="main-header-logo">
...
`;var D=`<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 258 39" fill="currentColor">
...
`;var U=`<svg width="370" height="370" viewBox="0 0 370 370" fill="none" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink">
...
`;var x={"linkedin-icon":Z,"linkedin-logo":A,"github-icon":T,"github-logo":F,"stackoverflow-icon":P,"stackoverflow-logo":X,"jsfiddle-icon":K,"jsfiddle-logo":H,"codersrank-icon":z,"codersrank-logo":D,"slot-machine-icon":U};var V="https://www.w3.org/2000/svg",b=new Map,E1=()=>`
  <svg xmlns="${V}" display="none">
  ${Object.entries(x).map(([e,t])=>(b.set(e,{viewBox:t.match(/viewBox="([^"]+)"/i)?.[1]}),t.replace(`xmlns="${V}"`,`id="sprite-${e}"`).replaceAll(/\bsvg\b/g,"symbol"))).join("")}
  </svg>
`,q=E1;(()=>{if(typeof window>"u")return;document.write=window.write=()=>{},((t,o=[])=>Object.getOwnPropertyNames(t).forEach(r=>{let i=Object.prototype[r];o.includes(r)||Object.getOwnPropertyDescriptor(Object.prototype,r)?.configurable&&Object.defineProperty(Object.prototype,r,{configurable:!1,set:()=>{r!=="trace"&&console.trace(`Property "${r}" was changed in:`)},get:()=>i})}))(Object.prototype,["__proto__"]),window.satismeter=()=>{},window.requestAnimationFrame=window.requestAnimationFrame??(t=>{setTimeout(t)})})();var S1={"image/webp":"webp","image/jpeg":"jpg","image/png":"png"},M1={types:"",sizes:"",src:""},j1=({types:e,sizes:t,src:o}=M1)=>Object.entries(S1).filter(([r,i])=>e.includes(i)).flatMap(([r,i])=>`
    <source type="${r}" srcset="${t.split(",").map(n=>o.replace(new RegExp(`.(${e})$`),`_${n}.${i} ${n}w`))}" />
  `).join(""),O1=e=>{if(!e)return"";let{src:t,ratio:o,sizes:r,types:i="png|webp",alt:n="",itemprop:s=""}=e,[l,d]=o.split(":"),f=+r.split(",")[0],c=f*+l,u=f*+d;return`
    <picture>
      ${j1({types:i,sizes:r,src:t})}
      <img src="${i.includes("webp")?t.replace(/\..*$/,".webp"):t}" width="${c}" height="${u}" alt="${n}" itemprop="${s}" />
    </picture>
  `},B=O1;var R1=(e={})=>{let{className:t="",children:o,squire:r,tag:i="div"}=e,n="link-list";return t&&(n+=` ${t}`),r&&(n+=" link-list--squire"),`
      <${i} class="${n}">
        ${o?.map(s=>`<div class="link-list__item">${s}</div>`).join("")}
      </${i}>
    `},$=R1;var m="Page not found",k="Wrong request";var J=`query RepoFile($repo_owner: String!, $repo_name: String!, $object_path: String!) {
...
`;var I1=async e=>{let{data:t,errors:o}=await e.json();if(o)throw o[0];return t},Q=class e{constructor(){this.repoName="iegik.github.com";this.repoOwner="iegik";this.storeRoot="gh-pages:data"}static{this.instance=new e}static getInstance(){return this.instance}async request({query:t,variables:o}){if(typeof window>"u")return;let r=window.sessionStorage?.getItem("access_token"),i=window.sessionStorage?.getItem("token_type"),n=await fetch("https://api.github.com/graphql",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json",Authorization:`${i} ${r}`},body:JSON.stringify({query:t,variables:o})});return I1(n)}async getFile(t){let o=await this.request({query:J,variables:{repo_name:this.repoName,repo_owner:this.repoOwner,object_path:`${this.storeRoot}${t}.json`}});if(!o)throw Error(k);let{repository:{object:r}}=o;if(!r)throw Error(m);let{text:i}=r;return JSON.parse(i)}async getUserInfo(){let{user:t}=await this.request({query:Y,variables:{login:this.repoOwner}});if(!t)throw Error(k);return t}};var T1=e=>e.json(),t1=class e{static{this.instance=new e}constructor(){}static getInstance(){return this.instance}async request(t){let o=await fetch(`${location.protocol}//${location.host}/data${t}`,{headers:{"Content-Type":"application/json",Accept:"application/json"}});return T1(o)}async getFile(t){let o=await this.request(`${t}.json`);if(!o)throw Error(m);return o}};var F1=({className:e,name:t}={name:"unknown"})=>{let o=g();return setTimeout(()=>{if(typeof window>"u"||typeof document>"u")return;let r=document.getElementById(`sprite-${t}`)?.getAttribute("viewBox")||"0 0 0 0";o.current?.setAttribute("viewBox",r)}),`
    <svg class="${e}" preserveAspectRatio="xMidYMid meet" viewBox="${b.get(t)?.viewBox||"0 0 0 0"}" ref="${o}">
      <use xlink:href="#sprite-${t}" />
    </svg>
  `},p=F1;var xt="\u{1F34F},\u{1F330},\u{1F34B},\u{1F345},\u{1F346},\u{1F347},\u{1F353},\u{1F349},\u{1F350},\u{1F352},\u{1F351},\u{1F951}".split(","),{floor:bt,random:$t}=Math;var E=class{constructor(){this.id=null}toString(){let t=btoa(`${Math.ceil(Math.random()*1e13)+ +new Date}`).slice(10,18);return this.id=this.id||`ref-${t}`}get current(){return typeof window>"u"||typeof document>"u"?null:document.querySelector(`[ref=${this.id}]`)}},g=()=>new E;var X1=(e={})=>{let{className:t="link",children:o,tag:r="a",to:i="#",title:n="",onClick:s}=e,l=g();return setTimeout(()=>{s&&l.current&&l.current.addEventListener("click",s)}),`
      <${r} class="${t} link" href="${i}" title="${n}" ref="${l}" ${/^http/.test(i)?'rel="noopener noreferrer"':""}>
        ${o?.join?.("")}
      </${r}>
    `},h=X1;var H1=!1;var S=H1?()=>{}:(...e)=>{console.log(...e)};async function o1(e){let t=new Image;t.crossOrigin="Anonymous",t.src=e,await t.decode();let o=t.width,r=t.height,n=new OffscreenCanvas(o,r).getContext("2d");if(!n)return[];n.drawImage(t,0,0,o,r);let s=n.getImageData(0,0,o,r).data,l="\u2802\u2802\u2802\u2802\u2801\u2880\u2881\u2881\u288C\u288C\u2895\u2895\u2897\u2897\u289F\u289F\u28B7\u28B7\u28BF\u28BF",d=[],f=[];for(let c=0;c<r;c++){for(let u=0;u<o;u++){let v=(c*o+u)*4,M=s[v],j=s[v+1],O=s[v+2];if(s[v+3]===0)continue;let s1=(M+j+O)/3,R=Math.floor((1-s1/255)*10);d.push(l[R*2]+l[R*2+1]),f.push(`#${M.toString(16).padStart(2,"0")}${j.toString(16).padStart(2,"0")}${O.toString(16).padStart(2,"0")}`)}d[d.length-1]+=`
`}return[d.map(c=>`%c${c}`).join(""),...f.map(c=>`background-color: ${c};`)]}var D1=r1(),U1=()=>(setTimeout(async()=>{if(typeof window>"u"||typeof document>"u")return;let e=await o1("images/artursjansons_32.jpg");S(...e)}),`
    <header class="header">
      <a href="#/home" class="header__avatar" alt="avatar">${B({itemprop:"photo",src:"/images/artursjansons.jpg",ratio:"1:1",sizes:"432,216,64",types:"jpg|png|webp",alt:D1})}</a>
    </header>
  `),i1=U1;var V1=()=>`
    ...
    <article lang="en">
      <section id="home" itemscope itemtype="https://schema.org/Person">
        <header>
          ...
          ${$({squire:!0,children:[h({to:"https://linkedin.com/in/iegik",title:"LinkedIn",children:[p({name:"linkedin-icon",className:"link-list__icon"})]}),h({to:"https://github.com/iegik",title:"GitHub",children:[p({name:"github-icon",className:"link-list__icon"})]}),h({to:"https://profile.codersrank.io/user/iegik",title:"Coders Rank",children:[p({name:"codersrank-icon",className:"link-list__icon"})]}),h({to:"https://jsfiddle.net/user/iegik",title:"JSFiddle",children:[p({name:"jsfiddle-icon",className:"link-list__icon"})]}),h({to:"https://stackoverflow.com/users/771471/iegik",title:"Stack Overflow",children:[p({name:"stackoverflow-icon",className:"link-list__icon"})]})]})}
  ...
  `,n1=V1;var q1=N("./public/next/styles.min.css"),B1=Object.entries({"script-src":[`'nonce-${a}'`,"'strict-dynamic'","https://www.google-analytics.com","https://ssl.google-analytics.com","https://static.hotjar.com","https://js.sentry-cdn.com","'unsafe-inline'"],"img-src":["'self'","https://www.google-analytics.com","https://avatars.githubusercontent.com/","https://www.googletagmanager.com/"],"connect-src":["'self'","https://www.google-analytics.com","https://region1.google-analytics.com","https://in.hotjar.com","https://static.hotjar.com","https://content.hotjar.io","https://github.com/login/oauth/access_token","https://api.github.com/graphql","https://api.github.com/user","https://qilg4ch66b3vpgtevzccb5meum0ttfcl.lambda-url.eu-north-1.on.aws/","https://o171820.ingest.sentry.io/"],"style-src":[`'nonce-${a}'`,"https://static.hotjar.com"],"object-src":["'none'"],"base-uri":["'none'"],"frame-src":["https://vars.hotjar.com/"]}).reduce((e,[t,o])=>`${e};${t} ${o.join(" ")}`,"default-src 'self'"),G1="Art\u016Brs Jansons :: Web Developer",J1="Experienced web developer with a passion for innovation, automation and optimization",Y1=`<!DOCTYPE html>
<html lang="en" manifest="manifest.appcache">
  <head>
    <meta http-equiv="Content-Security-Policy" content="${B1}">
    <link rel="preload" as="font" href="/fonts/AlinaScript.woff" crossorigin>
    <title>${G1}</title>
    <meta name="description" content="${J1}" />
    <meta http-equiv="Content-type" content="text/html; charset=UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="theme-color" content="var(--color-primary-light)" />
    <style nonce="${a}">${q1}</style>
  </head>
  <body>
    ...
    <script async nonce="${a}" src="https://www.googletagmanager.com/gtag/js?id=G-5ZY8Y6X2C4"></script>
    <script nonce="${a}">
...
`;L("public/next/index.html",Y1);var Q1=`
CACHE MANIFEST
# rev ${y}
...
NETWORK:
*
`;L("public/next/manifest.appcache",Q1);
