(()=>{var g=class{toString(){let o=Math.round(Math.random()*1e6).toString(36);return this.id=this.id||`ref-${o}`}get current(){if(!!window?.document)return document.querySelector(`[ref=${this.id}]`)}},c=()=>new g;var l=0,p=!1,h="\u{1F34F},\u{1F330},\u{1F34B},\u{1F345},\u{1F346},\u{1F347},\u{1F353},\u{1F349},\u{1F350},\u{1F352},\u{1F351},\u{1F951}".split(","),{floor:B,random:R}=Math,P=e=>e[B(R()*e.length)],m=()=>{if(p)return;let[e,o,s]=[h,h,h].flatMap(P);if(e==o&&o==s){p=!0;let n=`You won in ${l} tries`;setTimeout(()=>{alert(n),p=!1},100),l=0}else l++;return`${e} ${o} ${s}`},L=()=>{let e=c();return setTimeout(()=>{e.current?.addEventListener("click",()=>{e.current.innerHTML=m()}),!!window?.document&&document.addEventListener("keyup",o=>{o.isComposing||o.keyCode===229||o.which!==13&&o.which!==32||(e.current.innerHTML=m())})}),`<center ref="${e}">${m()}</center>`};var J={"image/webp":"webp","image/jpeg":"jpg","image/png":"png"},q=({types:e,sizes:o,src:s})=>Object.entries(J).filter(([n,t])=>e.includes(t)).flatMap(([n,t])=>`
    <source type="${n}" srcset="${o.split(",").map(i=>s.replace(new RegExp(`.(${e})$`),`_${i}.${t} ${i}w`))}" />
  `).join(""),F=e=>{let{src:o,ratio:s,sizes:n,types:t="png|webp",loading:i,alt:H="",itemprop:N,className:O}=e,[E,T]=s.split(":");return`
    <picture class="${O}">
      ${q({types:t,sizes:n,src:o})}
      <img src="${t.includes("webp")?o.replace(/\..*$/,".webp"):o}" width="${E}" height="${T}" loading="${i}" alt="${H}" itemprop="${N}" />
    </picture>
  `},v=F;var C=`                      
      ..........      
    .'...,,;;;'..     
...
`;var G=()=>`
    <header class="header">
      <a href="#home" class="header__avatar" alt="avatar">${v({itemprop:"photo",src:"home/images/artursjansons.jpg",ratio:"1:1",sizes:"255,216,64",types:"jpg|png|webp",alt:C})}</a>
    </header>
  `,u=G;var f=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" enable-background="new 0 0 240 240" x="0px" y="0px" xml:space="preserve" fill="currentColor">
...
`;var w=`<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 55.2 14" version="1.1" viewBox="0 0 55.2 14" xml:space="preserve"  fill="currentColor">
...
`;var k=`<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 16 16" data-view-component="true" fill="currentColor">
  <path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z"/>
</svg>
`;var x=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 63 18">
...
`;var $=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 124 124" fill="currentColor" fill-rule="evenodd">
...
`;var M=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 622 124" fill="currentColor" fill-rule="evenodd">
...
`;var Z=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 46 33" stroke-width="1.8" fill="none" fill-rule="evenodd" stroke="currentColor">
...
</svg>`;var _=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 174 33" stroke-width="1.8" fill="none" fill-rule="evenodd" stroke="currentColor">
  <style>
    .jsfiddle-font { font: bold 30px sans-serif; }
  </style>
  <path d="M23.4888889,20.543316 C21.4404656,18.4187374 19.0750303,15.6666667 16.4832014,15.6666667 C13.8721947,15.6666667 11.7555556,17.6366138 11.7555556,20.0666667 C11.7555556,22.4967196 13.8721947,24.4666667 16.4832014,24.4666667 C18.8347252,24.4666667 19.9845474,23.0125628 20.6429148,22.312473" stroke-linecap="round"></path>
  <path d="M22.5111111,19.5900174 C24.5595344,21.7145959 26.9249697,24.4666667 29.5167986,24.4666667 C32.1278053,24.4666667 34.2444444,22.4967196 34.2444444,20.0666667 C34.2444444,17.6366138 32.1278053,15.6666667 29.5167986,15.6666667 C27.1652748,15.6666667 26.0154526,17.1207706 25.3570852,17.8208603" stroke-linecap="round"></path>
  <path d="M45,22.7331459 C45,19.1499462 42.7950446,16.079593 39.6628004,14.7835315 C39.6774469,14.5246474 39.7003932,14.2674038 39.7003932,14.0035978 C39.7003932,6.82243304 33.8412885,1 26.611593,1 C21.3985635,1 16.9102123,4.03409627 14.8051788,8.41527616 C13.7828502,7.62878013 12.503719,7.15547161 11.1134367,7.15547161 C7.77825654,7.15547161 5.07450503,9.84159999 5.07450503,13.1544315 C5.07450503,13.7760488 5.16938207,14.3779791 5.3477444,14.9418479 C2.74863428,16.4787471 1,19.2867709 1,22.5105187 C1,27.3287502 4.89630545,31.2367856 9.72803666,31.31094 L36.3341301,31.3109406 C41.1201312,31.3406346 45,27.4870665 45,22.7331459 L45,22.7331459 Z" stroke-linejoin="round"></path>
  <text x="50" y="28" class="jsfiddle-font" stroke="none" fill="currentColor">JSFiddle</text>
</svg>`;var b=`<svg viewBox="0 0 62 39" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="main-header-logo">
...
`;var y=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 258 39" fill="currentColor">
...
`;var D={"linkedin-icon":f,"linkedin-logo":w,"github-icon":k,"github-logo":x,"stackoverflow-icon":$,"stackoverflow-logo":M,"jsfiddle-icon":Z,"jsfiddle-logo":_,"codersrank-icon":b,"codersrank-logo":y},j=Object.entries(D).reduce((e,[o,s])=>({...e,[o]:s.match(/viewBox="((\d+(.\d+)? ?)+)"/)[1]}),{});var Y=({className:e,name:o})=>`
    <svg class="${e}" preserveAspectRatio="xMidYMid meet" viewBox="${j[o]}">
      <use xlink:href="#sprite-${o}" />
    </svg>
  `,a=Y;var K=e=>{let{className:o,children:s,squire:n}=e,t="link-list";return o&&(t+=` ${o}`),n&&(t+=" link-list--squire"),`
      <div class="${t}">
        ${s?.map(i=>`<div class="link-list__item">${i}</div>`).join("")}
      </div>
    `},I=K;var U=()=>`
    ${u()}
    <article lang="en">
      <section id="home" itemscope itemtype="http://schema.org/Person">
        <header>
          ...
          ${I({squire:!0,children:[`<a class="link-list__link" href="http://linkedin.com/in/iegik" title="LinkedIn">${a({name:"linkedin-icon",className:"link-list__icon"})}</a>`,`<a class="link-list__link" href="http://github.com/iegik" title="GitHub">${a({name:"github-icon",className:"link-list__icon"})}</a>`,`<a class="link-list__link" href="http://profile.codersrank.io/user/iegik" title="Coders Rank">${a({name:"codersrank-icon",className:"link-list__icon"})}</a>`,`<a class="link-list__link" href="http://jsfiddle.net/user/iegik" title="JSFiddle">${a({name:"jsfiddle-icon",className:"link-list__icon"})}</a>`,`<a class="link-list__link" href="http://stackoverflow.com/users/771471/iegik" title="Stack Overflow">${a({name:"stackoverflow-icon",className:"link-list__icon"})}</a>`]})}
          <div class="network">
          </div>
        </header>
      </section>
  ...
  `,S=U;var X=e=>{let{className:o,children:s,tag:n="button",onClick:t}=e,i=c();return setTimeout(()=>{t&&i.current?.addEventListener("click",t)}),`
      <${n} class="${o}" ref="${i}">
        ${s?.join("")}
      </${n}>
    `},z=X;var r="ae0dcffd947e0ca15a12",V="user repo";var Q=()=>{let e=document.querySelector('[name="login"]')?.value,o="1wasdwe";sessionStorage.setItem("id",o),document.location.href=`https://github.com/login/oauth/authorize?client_id=${r}&login=${e}&scope=${V}&state=${o}`},W=()=>`
    <div class="login">
      <div>
        <input type="text" name="login" placeholder="username" />
        ${z({className:"login__btn",children:["Login with ",a({name:"github-logo",className:"login__btn__icon"})],onClick:Q})}
      </div>
    </div>
  `,A=W;var e1=async()=>{let{access_token:e,scope:o,token_type:s}=await fetch("https://github.com/login/oauth/access_token",{method:"POST",body:JSON.stringify({client_id:r,client_secret:CLIENT_SECRET,code})}).then(t=>t.json());sessionStorage.setItem("access_token",e),sessionStorage.setItem("scope",o),sessionStorage.setItem("token_type",s);let n=await fetch("https://api.github.com/user",{method:"GET",headers:{Authorization:`${s} ${e}`}}).then(t=>t.json());console.log({data:n})},o1=()=>(setTimeout(()=>{let{protocol:e,hash:o}=location,[s,n]=o.split("?"),t=sessionStorage.getItem("id");if(new URLSearchParams(n).get("code")!==t)return history.go(-2);e1()}),"Loading..."),d=o1;var t1=e=>{switch(console.log(e),!0){case/^\/login$/.test(e):return A;case/^\/oauth$/.test(e):return d;default:return S}console.log({Oauth:d,uri:e})};if(window?.document){let{protocol:e,hash:o}=document.location,s=o.slice(1);document.getElementById("root").innerHTML=t1(s)()}})();
