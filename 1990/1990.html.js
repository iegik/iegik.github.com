#!/usr/bin/env node
"use strict";var et=Object.create;var _=Object.defineProperty;var ot=Object.getOwnPropertyDescriptor;var rt=Object.getOwnPropertyNames;var nt=Object.getPrototypeOf,it=Object.prototype.hasOwnProperty;var st=(t,e,o,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of rt(e))!it.call(t,i)&&i!==o&&_(t,i,{get:()=>e[i],enumerable:!(r=ot(e,i))||r.enumerable});return t};var ct=(t,e,o)=>(o=t!=null?et(nt(t)):{},st(e||!t||!t.__esModule?_(o,"default",{value:t,enumerable:!0}):o,t));var y=ct(require("fs")),b=(t,e)=>y.writeFileSync(t,e,{encoding:"utf8"}),g=t=>y.readFileSync(t,{encoding:"utf8"});var A=new Date,S=`v3.1.0-${A.toJSON()}`,n=btoa(`${Number(A)}`).slice(10,18);var u=t=>`<a ${/^http/.test(t.href)?' rel="noopener noreferrer"':""} href="${t.href}" title="${t.title}">${t.title}</a>`;var w=t=>t.replace(/[&<"']/g,e=>{switch(e){case"&":return"&amp;";case"<":return"&lt;";case'"':return"&quot;";default:return"&#039;"}});var v=({src:t,ascii:e})=>`<pre><font size=1><img width="128" height="128" src="${t}" alt="${w(g(e))}" /></font></pre>`;var P=({src:t,title:e})=>`<fieldset bgcolor="green">
                                                <legend>${e}</legend>
                                                <code width="120px">${w(g(t))}</code>
                                            </fieldset>`;var c=({srcDoc:t,src:e,nonce:o,async:r,prefix:i,postfix:s,iife:l,crossorigin:m="",integrity:p})=>{let d=t?g(t):"";return`<script ${r?"async":""} crossorigin="${m}" ${p?`integrity="${p}"`:""} nonce="${o}" ${e?`src="${e}"`:""}>${i||""}${l?`(${d})(${l});`:d}${s||""}</script>`};var F=({nonce:t,gtmId:e})=>`
...
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>`;var C=({nonce:t,gtmId:e})=>`
...
`)}
                                                      ...
                                                      </table>`:`<input type="${i||"text"}" id="${p}" name="${t}" value="${s}" ${d} />`};var at=({nonce:t})=>Object.entries({"script-src":[`'nonce-${t}'`,"'strict-dynamic'","https://www.google-analytics.com","https://ssl.google-analytics.com","https://static.hotjar.com","https://script.hotjar.com","https://js.sentry-cdn.com","'unsafe-inline'"],"img-src":["'self'","https://www.google-analytics.com","https://avatars.githubusercontent.com/","https://www.googletagmanager.com/","https://static.hotjar.com","https://survey-images.hotjar.com"],"connect-src":["'self'","https://www.google-analytics.com","https://region1.google-analytics.com","https://in.hotjar.com","wss://ws.hotjar.com","https://static.hotjar.com","https://content.hotjar.io","https://github.com/login/oauth/access_token","https://api.github.com/graphql","https://api.github.com/user","https://o171820.ingest.sentry.io/"],"style-src":["'self'",`'nonce-${t}'`,"https://static.hotjar.com"],"object-src":["'none'"],"base-uri":["'none'"],"frame-src":["https://vars.hotjar.com/"],"script-src-elem":["'self'",`'nonce-${t}'`,"https://script.hotjar.com"]}).reduce((e,[o,r])=>`${e};${o} ${r.join(" ")}`,"default-src 'self'"),N=({nonce:t})=>`<meta http-equiv="Content-Security-Policy" content="${at({nonce:t})}">`;var B=({children:t})=>{if(typeof document>"u")return Array.isArray(t)?t.join(""):t;let e=document.createDocumentFragment();return Array.isArray(t)?[].forEach.call(t,o=>{e.appendChild(o)}):t!=null&&e.appendChild(t),e};var j=(t,...e)=>{let o=String.raw({raw:t},...e);if(typeof document>"u")return o;let r=document.createElement("div");return r.innerHTML=o,r.firstElementChild||""};var lt=({children:t,speed:e=1})=>j`
    <marquee
      direction="down"
      scrollamount="5"
      scrolldelay="${60*e}"
...
`}return m},O=({speed:t=1,count:e=1,step:o=.25,...r})=>[...new Array(e)].map((i,s)=>lt({children:pt(r),speed:t+(s+1)*o})),M=({width:t=800,height:e=600,avg:o=.01,snowFlake:r="*",nonce:i=""}={})=>{let s=~~(e/8*1e3*.5),l=B({children:O({width:t,height:e,avg:o,snowFlake:r,speed:1,count:3,step:.25})});return typeof window<"u"&&setTimeout((m=>()=>{O({width:t,height:e,avg:o,snowFlake:r,speed:1,count:3,step:.5}).forEach(p=>{p!=null&&m.append?.(p)})})(l),s),j`
  <noscript>${l}</noscript>
  ${c({srcDoc:"./src/lib/snow.js",nonce:i})}
  <style nonce="${i}">.snowCanvas { position: absolute;top: 0;color:rgba(200,200,200,0.8);user-select: none;pointer-events: none;}</style>`};var E=g("./src/pages/1990/styles.css"),x="Art&#363;rs Jansons",L="Full-stack Developer",I="10+ year exp.",dt=`${x} | ${L} [${I}]`,D="Mobile / Web Developer &amp; JavaScript Consultant",mt="HTML, CSS, JavaScript, TypeScript, React, React Native, PHP, MySQL, Bash, Makefile, Docker, GraphQL, Next, Nest",V=()=>`<p>
                        1990 |
                    ...
                    <table border="0" cellpadding="0" cellspacing="8" width="768px">
                        <tr>
                            <td>
                                ${v({src:"/images/me-thumb.png",ascii:"./src/pages/1990/assets/me.ascii"})}
                    ...
                    <table border="0" cellpadding="0" cellspacing="8">
                        <tr>
                            <td align="center">
                                ${v({src:"/images/me-thumb.png",ascii:"./src/pages/1990/assets/photo.ascii"})}
                                <p>${x}
                                <h1>
                    ...
                    <table border="0" cellpadding="0" cellspacing="8">
                        <tr>
                            <td align="center">
                                ${M({width:200,height:600,snowFlake:".",nonce:n})}
                    </table>
...
<head>
    ...
    ${c({srcDoc:"./src/lib/console-game.js",nonce:n})}
    ${c({srcDoc:"./src/lib/guard.js",nonce:n})}
...
<body style="position: relative;">
    ...
    ${c({srcDoc:"./src/lib/dos-theme.js",iife:'document, toggleDosStyle, "/1990/styles.min.css"',nonce:n,prefix:`const nonce = '${n}';
`})}
    ${c({srcDoc:"./src/lib/my-portfolio.js",nonce:n})}
...
<head>
    ...
    <style nonce="${n}" id="/1990/styles.min.css">${E}</style>
    ${c({srcDoc:"./src/lib/router-1990.min.js",nonce:n})}
...
`);var vt=()=>"<my-portfolio></my-portfolio>";b("public/1990/desktop/index.html",z(tt([V(),yt(),X()])));b("public/1990/mobile/index.html",z(tt([V(),wt(),X()])));b("public/portfolio/index.html",z(vt()));var kt=`
CACHE MANIFEST
# rev ${S}
